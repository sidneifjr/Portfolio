    ...
    render(){
        return (
            <section className="intro">
                ...
                <p data-anime="left">Olá, bem vindo! Sou estudante de Sistemas de Informação (5º período), 23 anos, com foco em Front-End e UI/UX. Apaixonado por tecnologia, decidi seguir a carreira em Web após o fim de meu ensino técnico.</p>
